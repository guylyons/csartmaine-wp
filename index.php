    ...
    <section class="content-area" id="content-area">
        <main role="main" class="site-main" id="main">
            ...
            <section class="row blog-container" style="text-align: center;">
                ...
                <p>Get the newest information about what’s going on with your favorite artists, community supported art, and other random happenings around Maine and elsewhere.</p>
